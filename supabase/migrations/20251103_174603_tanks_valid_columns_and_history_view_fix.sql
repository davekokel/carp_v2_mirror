...
BEGIN
  SELECT col INTO src_from FROM (
    SELECT 'created_at'::text AS col WHERE EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='join_fish_tanks' AND column_name='created_at')
    UNION ALL SELECT 'inserted_at'::text AS col WHERE EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='join_fish_tanks' AND column_name='inserted_at')
    UNION ALL SELECT 'joined_at'::text AS col WHERE EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='join_fish_tanks' AND column_name='joined_at')
    UNION ALL SELECT 'start_at'::text AS col WHERE EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='join_fish_tanks' AND column_name='start_at')
    UNION ALL SELECT 'start_time'::text AS col WHERE EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='join_fish_tanks' AND column_name='start_time')
  ) s LIMIT 1;

  SELECT col INTO src_to FROM (
    SELECT 'ended_at'::text AS col WHERE EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='join_fish_tanks' AND column_name='ended_at')
    UNION ALL SELECT 'left_at'::text AS col WHERE EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='join_fish_tanks' AND column_name='left_at')
    UNION ALL SELECT 'stop_at'::text AS col WHERE EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='join_fish_tanks' AND column_name='stop_at')
    UNION ALL SELECT 'end_time'::text AS col WHERE EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='join_fish_tanks' AND column_name='end_time')
  ) s LIMIT 1;
