...
SELECT
  ...
  COALESCE(tg.transgene_pretty,'')::text  AS transgene_pretty,
  COALESCE(tg.genotype_rollup,'')::text   AS genotype_rollup,
...
LEFT JOIN public.v_fish_genotypes tg   ON tg.fish_uuid = f.fish_uuid;
