...
WITH treated AS (
  SELECT
    ...
    tls.genotype_basecode_code   AS treat_basecodes,
    tls.fluor_tag_style          AS treat_fluortag_style,
    tls.fluor_organelle_style    AS treat_organelle_style,
...
untreated AS (
  SELECT
    ...
    NULL::text                   AS treat_fluortag_style,
    NULL::text                   AS treat_organelle_style,
