...
SELECT
  r.id::text AS roi_id,
  ps.plate_id AS plate_id,
  ps.plate_code,
  ps.experiment_date,
  ps.experiment_name,
  ps.plate_note,

  ps.slot_id AS slot_id,
  ps.slot_label,
  ps.slot_index,
  ps.slot_note,
  ...
  gms.genotype_tg_style AS genotype_tg_style,
  gms.genotype_fluortag_style AS genotype_fluortag_style,
  gms.genotype_fluororganelle_style AS genotype_fluororganelle_style,
