...
'Legacy-only helper: one row per clutch with genotype_basecode_allele_style from raw.legacy_clutch_transgene_alleles_v9, rolled as basecode(nickname) tokens.';
