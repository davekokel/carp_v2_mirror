...
WITH treated AS (
  SELECT
    ...
    COALESCE(tls.genotype_basecode_code, '')    AS treat_basecodes,
    COALESCE(tls.fluor_tag_style, '')           AS treat_fluortag_style,
    COALESCE(tls.fluor_organelle_style, '')     AS treat_organelle_style,
