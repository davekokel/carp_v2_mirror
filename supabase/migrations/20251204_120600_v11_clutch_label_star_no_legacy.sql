...
-- v11 clutch label star rewritten to remove dependency on clutches.legacy_genotype_*.
-- Column list and types are kept identical to the existing view so CREATE OR REPLACE
-- does not drop or add columns.
