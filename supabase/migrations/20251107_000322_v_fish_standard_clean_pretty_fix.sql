...
-- Recreate v_fish_standard_clean using v_fish_overview_id as the base
...
pick AS (
  -- One allele per fish_code: latest by global allele_number
...
SELECT
  v.*,  -- all existing columns from v_fish_overview_id, including birthday, rollups, etc.
