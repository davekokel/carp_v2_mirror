...
select
  v.clutch_code::text                      as conceptual_cross_code,  -- 1st data col
  ...
  -- mom tank: prefer prefilled mother_tank_id; else derive from live membership
  coalesce(
  ...
  -- dad tank: prefer prefilled father_tank_id; else derive from live membership
  coalesce(
