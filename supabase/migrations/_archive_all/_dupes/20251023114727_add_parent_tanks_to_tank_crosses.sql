...
ALTER TABLE public.tank_crosses
  ADD COLUMN IF NOT EXISTS mom_tank_id uuid,
  ADD COLUMN IF NOT EXISTS dad_tank_id uuid;

ALTER TABLE public.tank_crosses
  ADD CONSTRAINT tank_crosses_mom_tank_fkey
  FOREIGN KEY (mom_tank_id) REFERENCES public.tanks(tank_id) ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE public.tank_crosses
  ADD CONSTRAINT tank_crosses_dad_tank_fkey
  FOREIGN KEY (dad_tank_id) REFERENCES public.tanks(tank_id) ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;
