-- New canonical view: v_fish_standard_clean_v2
-- Derives allele_name = 'gu'||allele_number and computes genotype correctly.

CREATE OR REPLACE VIEW public.v_fish_standard_clean_v2
  (fish_code,
   name,
   nickname,
   genetic_background,
