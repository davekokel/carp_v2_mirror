...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE table_schema='public' AND table_name='mounts' AND column_name='time_mounted'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema='public' AND table_name='mounts' AND column_name='mounting_orientation'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema='public' AND table_name='mounts' AND column_name='n_top'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema='public' AND table_name='mounts' AND column_name='n_bottom'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema='public' AND table_name='mounts' AND column_name='seq'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema='public' AND table_name='mounts' AND column_name='mount_code'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE conrelid='public.mounts'::regclass AND conname='uq_mounts_run_seq'
  ) THEN
    ALTER TABLE public.mounts
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conrelid='public.mounts'::regclass AND conname='uq_mounts_code'
  ) THEN
    ALTER TABLE public.mounts
