...
base_clutches AS (
  SELECT
    ...
    g.genotype_code,
    -- coalesce v11 + legacy genotype for basecodes + pretty
    COALESCE(g.genotype_basecodes, c.legacy_genotype_base_codes) AS genotype_basecodes,
    COALESCE(g.genotype_pretty,     c.legacy_genotype_pretty)     AS genotype_pretty,
