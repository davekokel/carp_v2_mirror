...
begin
  for r in
    ...
    where c.relkind = 'v'
      ...
      and c.relname ~* '^(vw?_)?fish_overview(_.*)?$'      -- matches v_fish_overview*, vw_fish_overview_with_label*, etc.
...
-- 3) Canonical label view: decorator over base (no relaxed semantics)
