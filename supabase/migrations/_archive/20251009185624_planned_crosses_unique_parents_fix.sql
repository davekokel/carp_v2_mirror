...
FROM ranked AS r_keep
INNER JOIN ranked AS r_dup
    ON
        r_keep.clutch_id = r_dup.clutch_id
...
WITH cand AS (
    ...
    INNER JOIN pc_dups_map AS d ON c.planned_cross_id = d.dup_id
),
