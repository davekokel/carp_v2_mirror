...
CREATE INDEX IF NOT EXISTS idx_cc_clutch ON public.clutch_containers USING btree (clutch_id);
...
CREATE INDEX IF NOT EXISTS idx_cc_created_desc ON public.clutch_containers USING btree (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_cc_selection ON public.clutch_containers USING btree (selection_label);
...
CREATE INDEX IF NOT EXISTS idx_cgo_clutch ON public.clutch_genotype_options USING btree (clutch_id);
...
CREATE INDEX IF NOT EXISTS idx_clutches_batch ON public.clutches USING btree (batch_label);
...
CREATE INDEX IF NOT EXISTS idx_clutches_created_desc ON public.clutches USING btree (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_clutches_cross_id ON public.clutches USING btree (cross_id);
...
CREATE INDEX IF NOT EXISTS idx_clutches_run_id ON public.clutches USING btree (run_id);
...
CREATE INDEX IF NOT EXISTS idx_clutches_seed ON public.clutches USING btree (seed_batch_id);
...
CREATE INDEX IF NOT EXISTS idx_containers_created_desc ON public.containers USING btree (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_containers_type_status ON public.containers USING btree (container_type, status);
...
CREATE INDEX IF NOT EXISTS idx_cpga_plan ON public.cross_plan_genotype_alleles USING btree (plan_id);
...
CREATE INDEX IF NOT EXISTS idx_cpt_plan ON public.cross_plan_treatments USING btree (plan_id);
...
CREATE INDEX IF NOT EXISTS idx_cpt_plasmid ON public.cross_plan_treatments USING btree (plasmid_id);
...
CREATE INDEX IF NOT EXISTS idx_cpt_rna ON public.cross_plan_treatments USING btree (rna_id);
...
CREATE INDEX IF NOT EXISTS idx_cross_plan_runs_date ON public.cross_plan_runs USING btree (planned_date);
...
CREATE INDEX IF NOT EXISTS idx_cross_plan_runs_plan ON public.cross_plan_runs USING btree (plan_id);
...
CREATE INDEX IF NOT EXISTS idx_cross_plans_created_by ON public.cross_plans USING btree (created_by);
...
CREATE INDEX IF NOT EXISTS idx_cross_plans_day_father ON public.cross_plans USING btree (plan_date, father_fish_id);
...
CREATE INDEX IF NOT EXISTS idx_cross_plans_day_mother ON public.cross_plans USING btree (plan_date, mother_fish_id);
...
CREATE INDEX IF NOT EXISTS idx_cross_plans_father ON public.cross_plans USING btree (father_fish_id);
...
CREATE INDEX IF NOT EXISTS idx_cross_plans_mother ON public.cross_plans USING btree (mother_fish_id);
...
CREATE INDEX IF NOT EXISTS idx_cross_plans_nick ON public.cross_plans USING btree (plan_nickname);
...
CREATE INDEX IF NOT EXISTS idx_cross_plans_plan_date ON public.cross_plans USING btree (plan_date);
...
CREATE INDEX IF NOT EXISTS idx_cross_plans_tank_a ON public.cross_plans USING btree (tank_a_id);
...
CREATE INDEX IF NOT EXISTS idx_cross_plans_tank_b ON public.cross_plans USING btree (tank_b_id);
...
CREATE INDEX IF NOT EXISTS idx_cross_plans_title ON public.cross_plans USING btree (plan_title);
...
CREATE INDEX IF NOT EXISTS idx_crosses_created_desc ON public.crosses USING btree (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_crosses_parents_code ON public.crosses USING btree (mother_code, father_code);
...
CREATE INDEX IF NOT EXISTS idx_csh_changed_at ON public.container_status_history USING btree (changed_at);
...
CREATE INDEX IF NOT EXISTS idx_csh_container ON public.container_status_history USING btree (container_id);
...
CREATE INDEX IF NOT EXISTS idx_ct_clutch ON public.clutch_treatments USING btree (clutch_id);
...
CREATE INDEX IF NOT EXISTS idx_fsbm_fish_id ON public.fish_seed_batches_map USING btree (fish_id);
...
CREATE INDEX IF NOT EXISTS idx_fsbm_logged_at ON public.fish_seed_batches_map USING btree (logged_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_fsbm_seed_batch_id ON public.fish_seed_batches_map USING btree (seed_batch_id);
...
CREATE INDEX IF NOT EXISTS idx_ftm_container ON public.fish_tank_memberships USING btree (container_id);
...
CREATE INDEX IF NOT EXISTS idx_ftm_fish ON public.fish_tank_memberships USING btree (fish_id);
...
CREATE INDEX IF NOT EXISTS idx_ftm_fish_id ON public.fish_tank_memberships USING btree (fish_id);
...
CREATE INDEX IF NOT EXISTS idx_label_items_job_seq ON public.label_items USING btree (job_id, seq);
...
CREATE INDEX IF NOT EXISTS idx_label_items_request ON public.label_items USING btree (request_id);
...
CREATE INDEX IF NOT EXISTS idx_label_items_tank ON public.label_items USING btree (tank_id);
...
CREATE INDEX IF NOT EXISTS idx_label_jobs_entity ON public.label_jobs USING btree (entity_type, entity_id);
...
CREATE INDEX IF NOT EXISTS idx_label_jobs_requested_by ON public.label_jobs USING btree (requested_by, requested_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_label_jobs_status ON public.label_jobs USING btree (status, requested_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_load_log_fish_fish_id ON public.load_log_fish USING btree (fish_id);
...
CREATE INDEX IF NOT EXISTS idx_planned_crosses_clutch ON public.planned_crosses USING btree (clutch_id);
...
CREATE INDEX IF NOT EXISTS idx_plasmid_registry_code ON public.plasmid_registry USING btree (plasmid_code);
...
CREATE INDEX IF NOT EXISTS idx_rna_registry_code ON public.rna_registry USING btree (rna_code);
...
CREATE INDEX IF NOT EXISTS idx_rnas_source_plasmid ON public.rnas USING btree (source_plasmid_id);
...
CREATE INDEX IF NOT EXISTS idx_ta_base_nick_ci ON public.transgene_alleles USING btree (transgene_base_code, lower(allele_nickname));
...
CREATE INDEX IF NOT EXISTS idx_vfltc_fish ON public.fish_tank_memberships USING btree (fish_id);
...
CREATE INDEX IF NOT EXISTS ix_injected_rna_treatments_rna ON public.injected_rna_treatments USING btree (rna_id);
...
CREATE INDEX IF NOT EXISTS ix_registry_base_code ON public.transgene_allele_registry USING btree (base_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uniq_registry_base_legacy ON public.transgene_allele_registry USING btree (base_code, legacy_label) WHERE ((base_code IS NOT NULL) AND (legacy_label IS NOT NULL));
...
CREATE UNIQUE INDEX IF NOT EXISTS uniq_registry_modern_key ON public.transgene_allele_registry USING btree (transgene_base_code, allele_nickname) WHERE ((transgene_base_code IS NOT NULL) AND (allele_nickname IS NOT NULL));
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_clutch_plans_clutch_code ON public.clutch_plans USING btree (clutch_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_clutches_instance_code ON public.clutches USING btree (clutch_instance_code) WHERE (clutch_instance_code IS NOT NULL);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_clutches_planned_by_date ON public.clutches USING btree (planned_cross_id, date_birth);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_containers_tank_code ON public.containers USING btree (tank_code) WHERE (tank_code IS NOT NULL);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_crosses_concept_pair ON public.crosses USING btree (upper(TRIM(BOTH FROM mother_code)), upper(TRIM(BOTH FROM father_code)));
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_crosses_cross_code ON public.crosses USING btree (cross_code) WHERE (cross_code IS NOT NULL);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_fsbm_batch_fish ON public.fish_seed_batches_map USING btree (seed_batch_id, fish_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_fta_fish_base ON public.fish_transgene_alleles USING btree (fish_id, transgene_base_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_ftm_fish_open ON public.fish_tank_memberships USING btree (fish_id) WHERE (left_at IS NULL);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_ipt_natural ON public.injected_plasmid_treatments USING btree (fish_id, plasmid_id, at_time, amount, units, note);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_irt_natural ON public.injected_rna_treatments USING btree (fish_id, rna_id, at_time, amount, units, note);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_label_jobs_dedupe ON public.label_jobs USING btree (dedupe_hash) WHERE (dedupe_hash IS NOT NULL);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_planned_crosses_clutch_parents_canonical ON public.planned_crosses USING btree (clutch_id, mother_tank_id, father_tank_id) WHERE ((is_canonical = true) AND (mother_tank_id IS NOT NULL) AND (father_tank_id IS NOT NULL));
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_planned_crosses_cross_code ON public.planned_crosses USING btree (cross_code) WHERE (cross_code IS NOT NULL);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_plasmids_code ON public.plasmids USING btree (code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_rna_txn_dedupe ON public.injected_rna_treatments USING btree (fish_id, rna_id, COALESCE(at_time, '1969-12-31 16:00:00-08'::timestamp with time zone), COALESCE(amount, (0)::numeric), COALESCE(units, ''::text), COALESCE(note, ''::text));
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_rnas_one_per_plasmid ON public.rnas USING btree (source_plasmid_id) WHERE (source_plasmid_id IS NOT NULL);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_tar_base_number ON public.transgene_allele_registry USING btree (transgene_base_code, allele_number);
