...
CREATE UNIQUE INDEX IF NOT EXISTS uq_ft_proteins_ft_fluor_tag_norm ON public.ft_proteins (ft_code,(COALESCE(tag_code,'∅')),fluor_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_ft_dyes_ft_dye ON public.ft_dyes (ft_code,dye_code);
