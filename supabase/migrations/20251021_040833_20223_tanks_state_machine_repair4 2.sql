...
CREATE OR REPLACE FUNCTION public.move_fish_to_tank(p_fish_id uuid, p_tank_code text, p_rack text DEFAULT NULL, p_position text DEFAULT NULL, p_note text DEFAULT NULL)
