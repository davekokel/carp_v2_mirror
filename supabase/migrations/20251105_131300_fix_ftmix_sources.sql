...
-- 1) Recreate ft_injection_mix_sources with a surrogate PK + constraints
...
-- One logical row per (ft_code, source_kind, item), coalescing textual vs coded refs
...
-- 2) Ensure the rest of the objects exist (idempotent)
