...
grid = st.data_editor(
    ...
    column_config={
        ...
        "fluor_code":    st.column_config.TextColumn("Fluor code", disabled=True),
        "fluor_name":    st.column_config.TextColumn("Fluor name", disabled=True),
