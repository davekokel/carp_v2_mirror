...
# Map mini-language field names → columns on v11_fish_instance_star_enriched
field_to_column = {
...
if free_text:
    ...
    where.append(
        ...
        " OR COALESCE(genotype_transgene_allele_code,'') ILIKE :ql"
...
st.data_editor(
    ...
    column_config={
        ...
        "genotype_transgene_allele_code": st.column_config.TextColumn("Genotype allele codes", disabled=True, width="large"),
        "genotype_v11_code":              st.column_config.TextColumn("Genotype v11 code", disabled=True),
