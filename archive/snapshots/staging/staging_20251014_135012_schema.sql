...
\restrict 54R4gZej1lOUXAq28Vh2oYDu8bCamosbcGamh1T6Hf86WwOTMw3t9iGeYLj1tXM
...
--
-- Name: v_bruker_mounts_enriched; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: v_clutch_instance_selections; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_clutch_instance_selections AS
...
--
-- Name: ix_bm_selection_id_uuid; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ix_ta_transgene_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_ta_transgene_id ON public.transgene_alleles USING btree (transgene_id);
...
--
-- Name: uq_clutch_instances_id_uuid; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uq_transgenes_transgene_base_code; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_transgenes_transgene_base_code ON public.transgenes USING btree (transgene_base_code);
...
--
-- Name: transgene_alleles fk_ta_transgene_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.transgene_alleles
    ADD CONSTRAINT fk_ta_transgene_id FOREIGN KEY (transgene_id) REFERENCES public.transgenes(id) ON DELETE RESTRICT;
...
\unrestrict 54R4gZej1lOUXAq28Vh2oYDu8bCamosbcGamh1T6Hf86WwOTMw3t9iGeYLj1tXM
