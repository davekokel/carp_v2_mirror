...
OUT_PATH = ROOT / "seed_kits" / "legacy_import" / "working" / "imaging_unmapped_treatments_strict_suggestions.csv"
...
def main() -> None:
    ...
    for u in unmapped:
        ...
        # Strict: only match when plasmid_code appears literally in treat_text
        for c in constructs:
